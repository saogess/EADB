...
<body>
    ...
    <form action="<%=request.getContextPath()%>/adminServlet?type=show" method="post">
	    <div style="height: 500px">
	        <div style="height: 80px"></div>
	        <div class="lanren"><h1 style="font-family: 'Adobe 仿宋 Std R';border: 1px solid #c0c0c0;text-align: center">信息查询</h1></div>​
	        <h3 class="text-muted" style="text-align: center">请在此输入查询信息</h3><br/>
	        <div style="text-align: center">
	            <input class="search_fence_text" type="text" name="loginName" id="loginName" style="margin: auto;margin-bottom: 20px;padding-left: 50px" ><br/>
