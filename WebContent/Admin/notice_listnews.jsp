...
<body>
    	<div style="height: 515px">
    		<c:forEach items="${Notice}" var="m">
    		<!--公告查询结果-->
			      
			        <div style="background-color: #ffffff;margin-left: 50px; margin-top: 20px; width: 400px;height: 200px;border: 1px solid #c0c0c0;float: left;">
			
			            <div style="width: 340px;height: 30px;background-color: #dcdcdc;position: relative;left: 20px;top:20px;">
			                <a>${m.nid}/管理员编号：${m.adminid}/管理员：${m.userName}</a>
			                <a style="float: right">${m.time}</a>
			            </div>
