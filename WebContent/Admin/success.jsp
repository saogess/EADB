...
<body>
    ...
    <div style="height: 515px">
        ...
        <div class="lanren"><h1 style="font-family: 'Adobe 仿宋 Std R';border: 1px solid #c0c0c0;text-align: center">操作成功</h1></div>​
        <h3 class="text-muted" style="text-align: center">请等待<span id="test">5</span>秒后跳转主页</h3><br/>
        <div style="text-align: center">
            <img src="image/boom.gif" style="height: 150px;width:150px;"><br/>
