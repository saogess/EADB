...
<body>
    ...
    <div class="admin_sigup" style="margin-left: 300px;" >
        <form action="<%=request.getContextPath()%>/noticeServlet?type=update" method="post">
            <div style="height: 30px"></div>
            <div style="font-size:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;公告信息修改</div>
            <div align="center">
                <table>
                    <br/>
                    <tr><th></th><td>
                        <div class="div-bor"><i class="icon-dial"></i>
                            <input type="text" style="height: 40px;width: 300px" class="form-control" name="noticeId" id="noticeId" placeholder="${sessionScope.Notice.nid}" ></div></td></tr>
                    <tr><th></th><td>
                        <br/>
                        <div class="div-bor"><i class="icon-date"></i>
                            <input type="text" style="height: 40px;width: 300px" class="form-control" name="data" id="data" placeholder="${sessionScope.Notice.time}" ></div></td></tr>
                    <tr><th></th><td>
                        <br/>
                        <div class="div-bor">
                            <textarea maxlength="200" id="status" name="status" style="font-size: 16px;padding-left:34px;" placeholder="${sessionScope.Notice.notice}"  rows="4" cols="36" onkeydown='countChar("status","counter");' onkeyup='countChar("status","counter");'></textarea>
                    ...
                    <tr><th></th><td>
                        <br/>
                    </td><td><a href="#" >修改时遇到的问题</a></td></tr>
                    <tr><th></th><td><a>修改验证</a></td><td></td></tr>
