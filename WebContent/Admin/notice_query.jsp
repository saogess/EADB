...
<body>
    ...
    <!--公告信息查询-->
	<form action="<%=request.getContextPath()%>/noticeServlet?type=show" method="post">
    <div style="height: 515px">
        ...
        <div style="text-align: center">
            <input class="search_fence_text" type="text" name="id" id="id" style="margin: auto;margin-bottom: 20px;padding-left: 50px" ><br/>
