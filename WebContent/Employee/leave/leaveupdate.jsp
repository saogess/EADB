...
<body>
<form accept-charset="UTF-8" action="<%=request.getContextPath()%>/leaveServlet?type=leaveupdate" method="post">
<div>
	<h1 align="center">个人请假信息修改</h1>
	<h2>请输入要修改的请假信息编号：<input type="text" id="lId" name="lId"  placeholder="请输入编号"/></h2>
